...
@section('adminContent')
    ...
    <div class="row">
     <div class="col-sm-12">
         <h4 class="pull-left page-title">EDIT CUSTOMERS</h4>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">Edit Customer Here</h3></div>
                <!-- Error -->
                @if ($errors->any())
                ...
                <div class="panel-body">
                    <form role="form" action="{{ route('update.customer',$customer->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="accountholder" class="form-control" id="accountholder" value="{{ $customer->accountholder }}">
                        </div>

                        <div class="form-group">
                            <label for="accountnumber">Account Number</label>
                            <input type="text" name="accountnumber" class="form-control" id="accountnumber" value="{{ $customer->accountnumber }}">
                        </div>

                        <div class="form-group">
                            <label for="bankname">Banak Name</label>
                            <input type="text" name="bankname" class="form-control" id="bankname" value="{{ $customer->bankname }}">
                        </div>

                        <div class="form-group">
                            <label for="bankbranch">Bank Branch</label>
                            <input type="text" name="bankbranch" class="form-control" id="bankbranch" value="{{ $customer->bankbranch }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if(!is_null($customer->photo))
                                <img src="{{ asset('uploads/customer/'.$customer->photo) }}" style="width:60px;height:auto;">
                            @else
                                <img src="{{ asset('uploads/customer/default.jpg') }}" style="width:60px;height:auto;">
                            @endif
                        </div>
