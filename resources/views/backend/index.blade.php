...
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">Welcome ! Here is monthly record</h4>
...
<div class="row">
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="mini-stat-info text-right text-muted">
                <span class="counter">{{ $orderTotal_amount; }}</span>
                Total Sales Amount
            </div>
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Total Earn (order) <span class="pull-right">60%</span></h5>
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="mini-stat-info text-right text-muted">
                <span class="counter">{{ $orderProduct; }}</span>
                Total Sales Product
            </div>
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Product <span class="pull-right">90%</span></h5>
                    <div class="progress progress-sm m-0">
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="mini-stat-info text-right text-muted">
                <span class="counter">{{ $totalExpence }}</span>
                Total Expence
            </div>
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Expence <span class="pull-right">60%</span></h5>
                    <div class="progress progress-sm m-0">
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Employee <span class="pull-right">57%</span></h5>
                    <div class="progress progress-sm m-0">
