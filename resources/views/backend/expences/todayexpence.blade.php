...
@section('title', 'Today Expences')

@section('adminContent')
<!-- Page-Title -->
<div class="row">
 <div class="col-sm-12">
     <h4 class="pull-left page-title">TODAY EXPENCES</h4>
     <ol class="breadcrumb pull-right">
         <li><a href="#">Inventory</a></li>
         <li><a href="#">Expences</a></li>
         <li class="active">Today Expences</li>
     </ol>
 </div>
</div>
 ...
 <div class="col-md-12">
     <div class="panel panel-default">
         <div class="panel-heading">
             <h3 class="panel-title">Only Today Expences Data Here <span class="badge pull-right">Total = {{ $expences_total }}</span></h3>
         </div>
