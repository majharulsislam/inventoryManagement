...
@section('title', 'This Month Expences')
...
<div class="row">
 <div class="col-sm-12">
     ...
     <ol class="breadcrumb pull-right">
         ...
         <li class="active">This Month Expences</li>
     </ol>
 </div>
</div>
 ...
 <div class="col-md-12">
     <div class="panel panel-default">
         <div class="panel-heading">
             <h3 class="panel-title">Current Month Expences List Here <span class="badge pull-right">Total = {{ $expences_total }}</span></h3>
         </div>
